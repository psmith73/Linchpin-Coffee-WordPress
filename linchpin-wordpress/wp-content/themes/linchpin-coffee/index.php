...
<head>
    ...
    <!-- <link rel="stylesheet" href="../../../../Intern Project/philip-smith/css/landing-page.css"> -->
    ...
    <main class="full-screen-nav">
        <section class="landing parallax overlay">
            <video autoplay muted loop class="video">
                <source src="<?php echo _img; ?>/video.mp4" type="video/mp4">
            </video>   
            <div class="logo d-flex flex-column-reverse justify-content-between flex-lg-row justify-content-lg-around flex-nowrap align-items-center text-center">
                ...
                <div class="col-2 col-11 col-lg-5 d-flex flex-column justify-content-center flex-nowrap justify-content-lg-end align-items-center">
                    <img class="linchpin" src="<?php echo _img; ?>/linchpin-coffee.svg" alt="A Linchpin which is the logo for Linchpin Coffee">
                    <br>
        ...
        <section class="nav-item d-flex flex-column align-items-center justify-content-center static-story">
            ...
            <a class="button" href="http://localhost:8888/linchpin/linchpin-wordpress/?page_id=8">Learn More <i class="fas fa-arrow-right"></i></a>
        </section>
        <section class="nav-item d-flex flex-column align-items-center justify-content-center overlay parallax bg-beans">
            <h2>The Beans</h2>
            <p>We're not saying we have the best coffee beans around, but.....we are</p>
            <a class="button" href="http://localhost:8888/linchpin/linchpin-wordpress/?page_id=13">Coffee Heaven <i class="fas fa-arrow-right"></i></a>
        </section>
        <section class="nav-item d-flex flex-column align-items-center justify-content-center static-brew">
            ...
            <a class="button" href="http://localhost:8888/linchpin/linchpin-wordpress/?page_id=15">Let's Brew This <i class="fas fa-arrow-right"></i></a>
        </section>
        <section class="nav-item d-flex flex-column align-items-center justify-content-center overlay parallax bg-blog">
            <h2>From Coffee With Love</h2>
            <p>Who doesn't want to read want to read all about the amazing world of coffee</p>
            <a class="button" href="http://localhost:8888/linchpin/linchpin-wordpress/?page_id=17">The Blog <i class="fas fa-arrow-right"></i></a>
        </section>
        <section class="nav-item d-flex flex-column align-items-center justify-content-center static-contact">
            ...
            <a class="button" href="http://localhost:8888/linchpin/linchpin-wordpress/?page_id=21">Talk To Us <i class="fas fa-arrow-right"></i></a>
        </section>
